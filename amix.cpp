...
static  const  char* player = "ffplay -f s16le -ar 32000 -ac 1 -";
...
static  int  init_filters(const  char* filters_descr)
{
  ...
  char* info = avfilter_graph_dump(filter_graph, NULL);
  printf("%s\n", info);
...
int  main(int  argc, char** argv)
{
  ...
  */
  ...
  //         goto end;
  //     }
  if ((ret = open_input_file_1("C:\\Users\\ChengKeKe\\Desktop\\test1.mp3")) < 0)
  {
    av_log(NULL, AV_LOG_ERROR, "open input file fail, ret: %d\n", ret);
    goto  end;
  }
  if ((ret = open_input_file_2("C:\\Users\\ChengKeKe\\Desktop\\test2.mp4")) < 0)
  {
    av_log(NULL, AV_LOG_ERROR, "open input file fail, ret: %d\n", ret);
    goto  end;
  }
